...
def get_obj_array_overlay_on_image(image,
                                              boxes,
                                              classes,
                                              scores,
                                              category_index,
                                              ...
                                              line_thickness=4):
  """
  Particularly useful for ROS message generation from Tensorflow predictions.
  Overlay labeled boxes on an image with formatted scores and label names.
  This function groups boxes that correspond to the same location
  and creates a display string for each detection and overlays these
  on the image.
  Returns an object array that can be used to construct vision_msgs/Detection2D messages
